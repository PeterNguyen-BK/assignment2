        ...
        $(document).on('click','#sadd_button',function(){
            var data = '<form action="/assignment2/Admin/insertService/" method="post" enctype="multipart/form-data"> <table class="table">'+
                            '<thead>'+
                                '<tr>'+
                                '<th scope="col">Name</th>'+
                                '<th scope="col">Description</th>'+
                            ...
                            '<tbody id="body_stable">'+
                            '<tr>'+
                            '<td><input type="text" class="form-control" id="name_add" name="name_add" placeholder="Enter name"></td>'+
                            '<td><textarea class="form-control" id="des_add" name="des_add" rows="9" placeholder="Enter description"></textarea></td>'+
                            '<td>'+
                            'Chọn file để upload:'+
                            '<input type="file" name="fileUpload" id="fileUpload">'+
                            '</td>'+
                            '<td><textarea class="form-control" id="task_add" name="task_add" rows="9" placeholder="Enter task"></textarea></td>'+
                            '</tr>'+
                            '</tbody>'+
                            '</table>'+'<br>';
            data=data + '<table class="table">'+
                            ...
                            '<tr>'+
                            '<td><input type="text" class="form-control" id="time_add_p" name="time_add_p" placeholder="Enter package_in_time"></td>'+
                            '<td><input type="text" class="form-control" id="month_add_p" name="month_add_p" placeholder="Enter package_in_month"></td>'+
                            '<td><input type="text" class="form-control" id="year_add_p" name="year_add_p" placeholder="Enter package_in_year"></td>'+
                            '<td><input type="text" class="form-control" id="unit_add_p" name="unit_add_p" placeholder="Enter unit"></td>'+
                            '</tr>'+
                            '</tbody>'+
                            '</table>';
            data=data+'<button type="button" class="btn btn-info mg10" id="sreturn" >return</button>';
            data=data+'<button type="submit" class="btn btn-success mg10" id="sadd_button_submit" >Submit add</button> </form>';
            document.getElementById("service").innerHTML = data; 
        });
        //end add data
        ///////////////////////////
